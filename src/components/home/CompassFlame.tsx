    ...
    >
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          Every interaction begins as a simple chat — clear, human, and in your tone.
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-3 text-left max-w-5xl mx-auto">
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-800 shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Select FMC, CCC, or The Builder — each designed for a different role.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-800 shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Open a Sohbat session and share what you need — from brand copy to pricing clarity to landing page flows.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-800 shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Get a copy-ready, tone-aligned response in real time. No dashboards, no friction — just clarity.
            </p>
          </div>
        </div>
      </div>
